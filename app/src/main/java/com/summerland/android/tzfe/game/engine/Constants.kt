...
class Constants {
    ...
    val NO_MORE_MOVES = "Sorry. No more moves possible. Try Undo?"
    val NO_MORE_UNDO = "Sorry. No undo's available. Undo's are limited to 5!"
    val NEW_HIGH_SCORE = "Oh YES. New PB reached."
    val WINNER = "AWESOME!, you have won the game. Keep playing!!!"

    // Game specific values
    val WIN_TARGET = 2048
    val EMPTY_TILE_VAL = 0
    val MAX_PREVIOUS_MOVES = 5
    val PB_MESG_THRESHOLD = 100

    // Board specifics
    val DIMENSION = 4
    val TILE_CNT = 16
    val TILE_WIDTH = 65.5
    val TILE_PADDING = 8.0
    val BOARD_CORNER_RADIUS = 2.0
    val TILE_CORNER_RADIUS = 5

    // Animation duration in seconds
    val ZERO_DURATION   = 0.00
    val QUICK_DURATION  = 0.09
    val NORMAL_DURATION = 0.25
    val SLOW_DURATION   = 0.45
    val LONG_DURATION   = 0.60
    val PAUSE_DURATION  = 1.00
    ...
    val RANDOM_RATIO = 0.7  // favours '2's over '4's by  ~4:1

    // Audio files
    val HORRAY_AUDIO_FN = "cheer.mp3"        // A MP# FILE
    val SAD_AUDIO_FN = "negative-beeps.wav"  // A WAV FILE
    val MP3_AUDIO = "mp3"                    // A WAV FILE
    val WAV_AUDIO = "wav"                    // A WAV FILE
    val AUDIO_SUBDIRECTORY = "sound.assets/"
